...
public class JuegoView extends JFrame {
	...
	public JuegoView(int filas) {
        ...
        btnVolver.setBounds(76, 140, 150, 23);
	...
	public String pedirNombre() {
	    return javax.swing.JOptionPane.showInputDialog(this, "Ingresá tu nombre:");
	}
	...
	public void mostrarResultado(ResultadoIntento resultado, char[] letrasPalabra) {

	    int cont = 0;

	    for (ResultadoLetra res : resultado.getResultado()) {

	        casillas[filaActual][cont].setText(letrasPalabra[cont] + "");

	        switch (res) {
	            case CORRECTA:
	                casillas[filaActual][cont].setBackground(Color.GREEN);		// VERDE
	                break;
	            case PRESENTE:
	                casillas[filaActual][cont].setBackground(Color.YELLOW);		// AMARILLO
	                break;
	            case AUSENTE:
	                casillas[filaActual][cont].setBackground(Color.GRAY);		// GRIS
	                break;
	        }
